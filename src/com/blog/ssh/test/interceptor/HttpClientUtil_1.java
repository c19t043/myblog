...
public class HttpClientUtil_1 {
	...
	private static Log log = LogFactory.getLog(HttpClientUtil_1.class);
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(SMFWEdit("2fa678bb16dd407fbafa03711a5ef078","3151647"));
	}
	
	public void main(){
		PoolingHttpClientConnectionManager connManager =  new PoolingHttpClientConnectionManager();
		
		connManager.setMaxTotal(100);//设置连接池大小
		connManager.setDefaultMaxPerRoute(connManager.getMaxTotal());//设置最大并发数
